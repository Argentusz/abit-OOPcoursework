...
const AG_GRID_LOCALE_RU = {
    ...
    lessThanOrEqual: 'Не более',
    greaterThanOrEqual: 'Не менее',
    ...
    groups: 'Группы строк',
    rowGroupColumnsEmptyMessage: 'Перетащите сюда для формирования группы',
    values: 'Значения',
    valueColumnsEmptyMessage: 'Перетащите сюда для агрегации',
    pivots: 'Названия столбцов',
    pivotColumnsEmptyMessage: 'Перетащите сюда для установки названий столбцов',
    ...
    addToLabels: 'Добавить ${variable} до названий',
    removeFromLabels: 'Удалить ${variable} из названий',
    ...
    ctrlC: 'Ctrl+C',
    ctrlX: 'Ctrl+X',
    copyWithHeaders: 'Скопировать с шапкой',
    copyWithGroupHeaders: 'Скопировать с группой шапок',
    cut: 'Вырезать',
    paste: 'Вставить',
    ctrlV: 'Ctrl+V',
...
export default AG_GRID_LOCALE_RU